...
namespace TedAzApp.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public IActionResult Index() => View(_roleManager.Roles.OrderBy(e => e.Name).ToList());
        ...
        public IActionResult UserList() => View(_userManager.Users.OrderBy(e => e.UserName).ToList());
